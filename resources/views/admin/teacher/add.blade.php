...
{{--                                <span class="text-danger">{{$errors->has('name') ? $errors->first('name') : ''}}</span>--}}
                        ...
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input23" class="col-sm-3 col-form-label">Designation</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="designation" id="horizontal-firstname-input23"/>
